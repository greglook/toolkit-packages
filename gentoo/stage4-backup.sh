...
# To customize this script, you can set the following environment variables:
#
# Location to save the backup to:
# STAGE4_LOCATION="/mnt/storage/backups"
#
# List of paths to exclude:
# STAGE4_CUSTOM_EXCLUDE="
# /home/mythtv/store/*
# /home/slake/media"
